...
# Contributor Rituals Checklist

✅ Issue linked → [#ISSUE_NUMBER]  
📜 CHANGELOG entry → Added in `CHANGELOG.md`  
🛡 Governance check → Passed review ✅  
📊 Stats update → Synced with `Community-Stats`  
🏆 CWL milestone → Logged if applicable  
📣 Announcement → Added to `Community-Noticeboard`  
🎉 Merge celebration → Recognition note in `CONTRIBUTORS.md`  

---
**Contributor:** @USERNAME  
**Repo:** [REPO_NAME]  
**Milestone:** [Describe milestone in 1 line]  
